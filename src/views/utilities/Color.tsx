...
export default function UIColor() {
  ...
  const schemeTheme = (theme as any).colorSchemes?.[scheme];

  const currentPalette = schemeTheme ? schemeTheme.palette : theme.palette;

  return (
    <MainCard title="Color Palette" secondary={<SecondaryAction title="Color Palette Reference" link="https://next.material-ui.com/system/palette/" icon={undefined} />}>
